...
export const schools: School[] = [
  // ═══════════════ UK ═══════════════
  {
    ...
    majorCategories: ["商科", "计算机", "工程", "传媒", "教育", "法律", "艺术设计", "理学", "社科", "地质学"],
  ...
  },
  {
    ...
    listPolicy: "open",
    preferredTiers: [],
    majorCategories: ["商科", "计算机", "工程", "传媒", "教育", "理学", "社科", "地质学"],
  ...
  },
  {
    ...
    listPolicy: "tiered",
    preferredTiers: ["985", "211", "双一流"],
    majorCategories: ["商科", "计算机", "工程", "理学", "社科", "地质学"],
  ...
  },// ═══════════════ Imperial / Oxford / Cambridge ═══════════════
  {
    ...
    majorCategories: ["商科", "计算机", "工程", "理学", "地质学"],
  ...
  },// ═══════════════ HK 香港 ═══════════════
  {
    ...
    majorCategories: ["商科", "计算机", "工程", "传媒", "教育", "法律", "理学", "社科", "地质学"],
    notes: "无公开院校 List，但 985/211 偏好明显。双非需 87-90%+ 且强背景。商科/法律/CS 竞争极强，面试常见。教育/社工/人文对双非相对友好",
  ...
  },
  {
    ...
    majorCategories: ["商科", "计算机", "工程", "传媒", "教育", "法律", "理学", "社科"],
    notes: "无公开院校 List。双非需 85-88%+。教育、社科、翻译对双非较友好，商科/工程偏向 985/211",
  ...
  },
  {
    ...
    majorCategories: ["商科", "计算机", "工程", "理学", "社科"],
    notes: "无公开院校 List，但双非最难申的港校。理工和商科极强，强烈偏好 985/211。双非需 88-90%+ 且有突出科研/实习",
  ...
  },
  {
    ...
    majorCategories: ["商科", "计算机", "工程", "传媒", "法律", "理学", "社科"],
    notes: "「双非之光」，对双非最友好的 QS 前100 港校。无院校限制，GPA 82-85% 即可申请",
  ...
  },
  {
    ...
    majorCategories: ["商科", "计算机", "工程", "传媒", "教育", "法律", "理学", "社科", "艺术设计", "地质学"],
  ...
  },
  {
    ...
    majorCategories: ["商科", "计算机", "工程", "教育", "法律", "理学", "社科", "地质学"],
  ...
  },
  {
    ...
    ieltsMin: 7.0, toeflMin: 94, gpaScale: "gpa4" as const, gpaRequirements: { preferred: 3.6, other: 3.6  }, listPolicy: "open", preferredTiers: [],
    majorCategories: ["商科", "计算机", "传媒", "教育", "法律", "理学", "社科", "地质学"],
  ...
  },
  {
    ...
    applicationFee: "US$90", listPolicy: "open", preferredTiers: [],
    majorCategories: ["商科", "计算机", "工程", "传媒", "理学", "社科", "地质学"],
  ...
  },
  {
    ...
    applicationFee: "US$85", listPolicy: "open", preferredTiers: [],
    majorCategories: ["商科", "计算机", "工程", "教育", "理学", "社科", "地质学"],
    extraRequirements: "GRE（部分项目要求）",
  ...
  },// ═══════════════ NL (补充) ═══════════════
  {
    ...
    ieltsMin: 6.5, toeflMin: 90, gpaScale: "percentage" as const, gpaRequirements: { preferred: 78, other: 80 },
    listPolicy: "open", preferredTiers: [],
    majorCategories: ["理学", "社科", "教育", "法律", "地质学"],
  ...
  // ═══════════════ SA (沙特) ═══════════════
  {
    ...
    ieltsMin: 6.0, toeflMin: 79, gpaScale: "percentage" as const, gpaRequirements: { preferred: 78, other: 80 },
    listPolicy: "open", preferredTiers: [],
    majorCategories: ["工程", "计算机", "理学", "商科", "地质学"],
  ...
  },
  {
    ...
    ieltsMin: 6.0, toeflMin: 80, gpaScale: "percentage" as const, gpaRequirements: { preferred: 75, other: 78 },
    listPolicy: "open", preferredTiers: [],
    majorCategories: ["工程", "理学", "社科", "法律", "地质学"],
