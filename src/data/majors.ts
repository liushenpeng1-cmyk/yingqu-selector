...
export const majorCategories: MajorCategory[] = [
  ...
  },
  {
    ...
    subMajors: [
      ...
      { id: "applied-psychology", name: "应用心理学", nameEn: "Applied Psychology", crossMajorFriendly: false, typicalBackgrounds: ["理学", "社科"] },
      { id: "clinical-psychology", name: "临床心理学", nameEn: "Clinical Psychology", crossMajorFriendly: false, typicalBackgrounds: ["理学", "医学"] },
      { id: "counseling-psychology", name: "心理咨询/咨询心理学", nameEn: "Counselling Psychology", crossMajorFriendly: false, typicalBackgrounds: ["理学", "社科", "教育"] },
      { id: "organizational-psychology", name: "组织心理学/工业心理学", nameEn: "Organizational / Occupational Psychology", crossMajorFriendly: true, typicalBackgrounds: ["理学", "商科", "社科"] },
      { id: "health-psychology", name: "健康心理学", nameEn: "Health Psychology", crossMajorFriendly: false, typicalBackgrounds: ["理学", "医学"] },
      { id: "forensic-psychology", name: "犯罪心理学/法医心理学", nameEn: "Forensic Psychology", crossMajorFriendly: false, typicalBackgrounds: ["理学", "社科", "法律"] },
      { id: "developmental-psychology", name: "发展心理学", nameEn: "Developmental Psychology", crossMajorFriendly: false, typicalBackgrounds: ["理学", "教育"] },
      { id: "cognitive-neuroscience", name: "认知神经科学", nameEn: "Cognitive Neuroscience", crossMajorFriendly: false, typicalBackgrounds: ["理学", "医学"] },
