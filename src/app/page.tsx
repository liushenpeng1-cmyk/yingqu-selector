...
export default function Home() {
    ...
    return schools
      ...
      .map((school) => {
        const progs = matchPrograms(
          ...
          ukClassification || undefined, auClassification || undefined
        );
  ...
  }, [tier, rawGpaInput, rawLangScore, langTest, targetCategoryId, currentCategoryName, targetSubMajorId, effectiveGpaScale, regions, ukClassification, auClassification]);
    ...
    <div className="min-h-screen">
      ...
      {step === "results" && studyLevel === "undergraduate" && (
        <main className="pt-20 sm:pt-24 pb-20 px-4 sm:px-6 max-w-5xl mx-auto animate-fade-in">
          ...
          {/* Budget Calculator — 本科默认 3 年(36 月) */}
          <BudgetCalculator defaultCurrency="GBP" defaultMonths="36" />
        </main>
      )}
      ...
      {step === "results" && studyLevel === "postgraduate" && (selectedSchool || isOverseasUndergrad || isJointUniversity) && (
        <main className="pt-20 sm:pt-24 pb-20 px-4 sm:px-6 max-w-5xl mx-auto animate-fade-in">
          ...
          {/* Budget Calculator — 硕士默认 1 年(12 月) */}
          <BudgetCalculator defaultCurrency="GBP" defaultMonths="12" />
